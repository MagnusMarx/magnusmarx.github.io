var map = {
    ...
    init: function() {
        ...
        a.p([-0.9998600000000001, 0.00014000000000000001, -44.99986], [0, 0, 0], [2, 2, 0.6], 0.0, 1000.0, 0, 0.6, false);
        a.p([1.00021, 0.00021, -49.999790000000004], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([1.00028, 0.00028000000000000003, -54.999719999999996], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([-0.99965, 0.00035000000000000005, -59.99965], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([0.00042, 0.00042, -74.99958], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([0.00049, 0.00049, -79.99951], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([0, 0, -70], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([1.00007, 0.00007000000000000001, -94.99993], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([-0.9998600000000001, 0.00014000000000000001, -64.99986], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        a.p([0.00021, 0.00021, -84.99978999999999], [0, 0, 0], [2, 2, 0.6], 0.0, 100.0, 0, 0.6, false);
        ...
        a.c([0, 0.3, -105], false);
        a.c([0.00007000000000000001, 0.09006999999999998, -36.99993], false);
        a.c([2.00014, 0.30013999999999996, -114.99986000000001], false);
        a.c([-0.99979, 0.30021, -124.99978999999999], false);
        a.c([1.00028, 0.30028, -114.99972], false);
        a.c([-0.99965, 0.30035, -114.99965], false);
        a.c([-1.99958, 0.30042, -124.99958000000001], false);
        a.c([-1.99951, 0.30049, -144.99951], false);
        a.c([0, 0.3, -125], false);
        a.c([1.00007, 0.30007, -124.99993], false);
        a.c([1.00014, 0.30013999999999996, -134.99986], false);
        a.c([2.00021, 0.30021, -134.99979], false);
        a.c([0.00028000000000000003, 0.30028, -114.99972], false);
        a.c([0.00035000000000000005, 0.30035, -134.99965], false);
        a.c([1.00042, 0.30042, -144.99958], false);
        a.c([0.00049, 0.30049, -144.99951], false);
        a.c([-1, 0.3, -145], false);
        a.c([2.82007, 0.30007, -134.99993], false);
        a.c([-2.90986, 0.30013999999999996, -124.99986000000001], false);
        a.c([2.87021, 0.30021, -114.99978999999999], false);
        a.c([1.93028, 0.30028, -144.99972], false);
        a.e([0.49034999999999995, 0.46035, -328.91965]);
    },
    post: function() {
        cc.refresh();
    },
    ...
    reset: function() {
        ...
        a.re('C13', [0, 0.3, -105], [0, 0, 0], [2, 2, 2]);
        a.re('C14', [0.00007000000000000001, 0.09006999999999998, -36.99993], [0, 0, 0], [2, 2, 2]);
        a.re('C15', [2.00014, 0.30013999999999996, -114.99986000000001], [0, 0, 0], [2, 2, 2]);
        a.re('C16', [-0.99979, 0.30021, -124.99978999999999], [0, 0, 0], [2, 2, 2]);
        a.re('C17', [1.00028, 0.30028, -114.99972], [0, 0, 0], [2, 2, 2]);
        a.re('C18', [-0.99965, 0.30035, -114.99965], [0, 0, 0], [2, 2, 2]);
        a.re('C19', [-1.99958, 0.30042, -124.99958000000001], [0, 0, 0], [2, 2, 2]);
        a.re('C20', [-1.99951, 0.30049, -144.99951], [0, 0, 0], [2, 2, 2]);
        a.re('C21', [0, 0.3, -125], [0, 0, 0], [2, 2, 2]);
        a.re('C22', [1.00007, 0.30007, -124.99993], [0, 0, 0], [2, 2, 2]);
        a.re('C23', [1.00014, 0.30013999999999996, -134.99986], [0, 0, 0], [2, 2, 2]);
        a.re('C24', [2.00021, 0.30021, -134.99979], [0, 0, 0], [2, 2, 2]);
        a.re('C25', [0.00028000000000000003, 0.30028, -114.99972], [0, 0, 0], [2, 2, 2]);
        a.re('C26', [0.00035000000000000005, 0.30035, -134.99965], [0, 0, 0], [2, 2, 2]);
        a.re('C27', [1.00042, 0.30042, -144.99958], [0, 0, 0], [2, 2, 2]);
        a.re('C28', [0.00049, 0.30049, -144.99951], [0, 0, 0], [2, 2, 2]);
        a.re('C29', [-1, 0.3, -145], [0, 0, 0], [2, 2, 2]);
        a.re('C30', [2.82007, 0.30007, -134.99993], [0, 0, 0], [2, 2, 2]);
        a.re('C31', [-2.90986, 0.30013999999999996, -124.99986000000001], [0, 0, 0], [2, 2, 2]);
        a.re('C32', [2.87021, 0.30021, -114.99978999999999], [0, 0, 0], [2, 2, 2]);
        a.re('C33', [1.93028, 0.30028, -144.99972], [0, 0, 0], [2, 2, 2]);
        a.re('E0', [0.49034999999999995, 0.46035, -328.91965], [0, 0, 0], [1, 1, 1]);
    },
