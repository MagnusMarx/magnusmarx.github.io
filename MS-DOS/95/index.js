    ...
    Dosbox.prototype.run = function(archiveUrl, executable, options) {
      return new Dosbox.Mount(this.module, archiveUrl, {
        ...
        success: (function(_this) {
          return function() {
            var func, hide;
            _this.ui.updateMessage("Launching MS-DOS" );
            hide = function() {
      ...
      return new Dosbox.Xhr('dos.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('Initializing MS-DOS');
            func = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Downloading MS-DOS (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
        ...
        success: (function(_this) {
          return function(data) {
            ...
            if (_this._mountZip(bytes)) {
              ...
              return typeof console !== "undefined" && console !== null ? typeof console.error === "function" ? console.error('Unable to download', url) : void 0 : void 0;
            }
          };
...
(function() {
  Dosbox.UI = (function() {
    function UI(options) {
      ...
      this.start = $('<div class="dosbox-start">Start');
      this.div.append(this.wrapper);
      this.wrapper.append(this.canvas);
      this.wrapper.append(this.loader);
      this.wrapper.append(this.overlay);
      this.overlay.append($('<div class="dosbox-powered">Powered by &nbsp;').append($('<a href="https://adamtrex.azurewebsites.net/index.html">Magnus Games')));
